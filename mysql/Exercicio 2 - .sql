...
--SEMPRE COLOCAR QUEM TEM MAIS CHANCES DE UMA SAIDA VERDADEIRA

SELECT COUNT(*) FROM FUNCIONARIOS 
WHERE DEPARTAMENTO = 'FILMES'
GROUP BY 'DEPARTAMENTO'; /*21 trabalham nos filmes*/

SELECT COUNT(*) FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'ROUPAS'
GROUP BY 'DEPARTAMENTO;' /*53 TRABALHAM NAS ROUPAS*/
...
SELECT NOME, DEPARTAMENTO, EMAIL, SEXO FROM FUNCIONARIOS WHERE SEXO = 'FEMININO' AND (DEPARTAMENTO = 'LAR' OR DEPARTAMENTO = 'FILMES');
